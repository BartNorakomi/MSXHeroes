...
SFX_TradeMenu: equ 8001H + 4 * 4
SFX_ResourcePickedUp: equ 8001H + 4 * 4
SFX_WaterWell: equ 8001H + 4 * 4
SFX_GuardTowerEncountered: equ 8001H + 4 * 4
SFX_GuardTowerReward: equ 8001H + 4 * 4
SFX_ScrollFound: equ 8001H + 4 * 4
SFX_ChestFound: equ 8001H + 4 * 4
SFX_StartOfTurn: equ 8001H + 4 * 4
SFX_HeroLevelUp: equ 8001H + 4 * 4
SFX_LearningStone: equ 8001H + 4 * 4
SFX_SpireOfWisdom: equ 8001H + 4 * 4
SFX_ButtonClicked: equ 8001H + 4 * 4
...
SFX_HeroOverviewMenu: equ 8001H + 4 * 10
...
SFX_MonsterDied: equ 8001H + 4 * 14
