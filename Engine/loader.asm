...
GentleCaveMap05: db  GentleCaveMap05MapBlock | dw GentleCaveMap05Map | db GentleCaveMap05ObjectLayerMapBlock | dw GentleCaveMap05ObjectLayerMap | db TilesGentleCaveBlock     |   incbin"..\grapx\tilesheets\PaletteGentleCave.pl",0,4 | db BattleFieldCaveBlock | db GentleCaveMiniMapsBlock | dw $4000 + (048*128) + (200/2) - 128                   | db "2",255,"M",255,"Westward and Eastward ",255,"A formidable sorcerer ",254,"named Dino reigns with",254,"dark power.           ",254,"His tyranny threatens ",254,"the land.             ",254,"Only by launching a   ",254,"coordinated assault   ",254,"from both the west and",254,"east can he be        ",254,"defeated.             ",254,                         254,"Two heroes arise.     ",254,"                      ",254,"Get ready to confront ",254,"Dino's might.         ",254,"                      ",254,"                      ",254,"                      ",254,"                      ",254,"                      ",254,"                      ",255
...
GentleDesertMap01: db  GentleDesertMap01MapBlock | dw GentleDesertMap01Map | db GentleDesertMap01ObjectLayerMapBlock | dw GentleDesertMap01ObjectLayerMap | db TilesGentleDesertBlock     |   incbin"..\grapx\tilesheets\PaletteGentleDesert.pl",0,4 | db BattleFieldDesertBlock | db GentleDesertMiniMapsBlock | dw $4000 + (096*128) + (000/2) - 128 | db "3",255,"L",255,"Prince Logan's Odyssey",255,"In the realm of       ",254,"Isrenhasa, Prince     ",254,"Logan embarks on a    ",254,"perilous quest to save",254,"his kingdom from      ",254,"darkness.             ",254,"He sets forth to free ",254,"two kingdoms ensnared ",254,"by sinister forces.   ",254,"Prince Logan must     ",254,"unlock the secrets of ",254,"ancient magic to      ",254,"restore peace to his  ",254,"world.                ",254,"With each step, he    ",254,"draws closer to       ",254,"fulfilling his destiny",254,"and vanquishing the   ",254,"shadows that threaten ",254,"to consume Isrenhasa. ",254,                         255
